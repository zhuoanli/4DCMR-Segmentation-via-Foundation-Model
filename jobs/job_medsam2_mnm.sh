...
#SBATCH --job-name=medsam2-mnm
#SBATCH --output=/scratch/gautschi/li4533/MIUA_2026/logs/medsam2_mnm-%j.log
#SBATCH --chdir=/scratch/gautschi/li4533/MIUA_2026/MedSAM2

set -e
echo "==== medsam2_mnm  Job: $SLURM_JOB_ID  Node: $(hostname)  $(date) ===="
...
python /scratch/gautschi/li4533/MIUA_2026/infer_medsam2.py \
    ...
    --out  /scratch/gautschi/li4533/MIUA_2026/results/medsam2_mnm \
    --overwrite

echo "==== medsam2_mnm DONE $(date) ===="
